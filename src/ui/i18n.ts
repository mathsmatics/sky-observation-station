...
Object.assign(I18N.zh, {
  ...
  clear: "清除",
  objectInfoEmpty:
    "单击恒星、太阳系天体、深空天体、星座或星官，查看名称、坐标、文化说明和当前地平位置；单击空白处会清除选择。",
  objectType: "类型",
  otherNames: "其他名称",
  magnitude: "视星等",
  ...
  starNameCulture: "恒星专名文化",
  bestViewingMonths: "大致适合观测月份：",
  relatedConstellations: "相关星座",
  culturalOrigin: "文化来源与形成",
  culturalRole: "星官职能",
  cultureRelationship: "文化关系与联想",
  cultureHierarchy: "传统体系位置",
  classicalQuotation: "古籍原文",
  bestViewingTime: "适合观测时段",
  cultureSources: "资料来源",
  mansion: "所属星宿",
  fourSymbol: "四象",
  enclosure: "所属三垣",
...
Object.assign(I18N.en, {
  ...
  clear: "Clear",
  objectInfoEmpty:
    "Click a star, Solar System body, deep-sky object, constellation, or asterism to inspect its names, coordinates, cultural notes, and current horizontal position. Clicking empty sky clears the selection.",
  objectType: "Type",
  ...
  starNameCulture: "Proper-name culture",
  bestViewingMonths: "Approx. best months: ",
  relatedConstellations: "Related constellations",
  culturalOrigin: "Cultural origin",
  culturalRole: "Asterism role",
  cultureRelationship: "Cultural relationships",
  cultureHierarchy: "Traditional hierarchy",
  classicalQuotation: "Classical quotation",
  bestViewingTime: "Viewing guide",
  cultureSources: "Sources",
