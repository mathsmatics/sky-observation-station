...
export const CATALOG_DATASETS: Record<CatalogDatasetKey, CatalogDatasetInfo> = {
  ...
  deepSky: {
    ...
    purposeEn:
      "bright DSO, complete Messier and complete Caldwell rendering, search and picking",
    source:
      "D3-Celestial bundled bright DSO data; OpenNGC v20231203; NOIRLab/KPNO Messier and Caldwell catalog snapshots",
  ...
  deepSkyNames: {
    ...
    source:
      "D3-Celestial bundled names, plus aliases derived from OpenNGC and NOIRLab/KPNO catalog identifiers",
    license: "mixed; OpenNGC CC BY-SA 4.0, other source status to verify",
    sourceStatus: "derived",
  },
